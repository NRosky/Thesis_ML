# -*- coding: utf-8 -*-
"""
Created on Mon Aug 21 16:07:33 2023
...
# # Define the Allowance range of ±0.5
allowY = (0.5)
...
#for rnd_st8 in random_states:
            ...
            plt.plot([0, y_test.max()+0.1], [0, y_test.max()+0.1], '--', color='r', lw=1.5)
            ...
            plt.axis([0, y_test.max()+0.1, 0, y_test.max()+0.1])
            #plt.grid(True)
...
output_df.to_excel('RD_NN(II)_DIA_test2_to_Excel_output_MinMaxNormal_output_n100iii.xlsx', index=False)
